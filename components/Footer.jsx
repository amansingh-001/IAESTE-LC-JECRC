        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 items-start">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex gap-3 sm:gap-4 justify-center md:justify-start">
              ...
              <SocialIcon href="https://www.facebook.com/IAESTEIndiaLCJECRC" ariaLabel="Facebook">
                <path d="M22.675 0h-21.35C.595 0 0 .595 0 1.326v21.348C0 23.405.595 24 1.326 24H12.82v-9.294H9.692V11.01h3.128V8.413c0-3.1 1.894-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.31h3.587l-.467 3.696h-3.12V24h6.116C23.405 24 24 23.405 24 22.674V1.326C24 .595 23.405 0 22.675 0z"/>
              </SocialIcon>
            </div>
          </div>
